...
export class ArtiklDialogComponent implements OnInit {
  ...
  public add(): void {
    this.artiklService.getNextID(this.artiklService.addArtikl, this.data);
    /*this.snackBar.open('Uspešno dodat artikl: ' + this.data.ime + ' ' + this.data.prezime, 'U redu',
      {
        duration: 2500
      });*/
  }
  ...
  public update(): void {
   ...
   /* this.snackBar.open('Uspešno modifikovan artikl: ' + this.data.ime + ' ' + this.data.prezime, 'U redu',
      {
        duration: 2500
      });*/
  }
